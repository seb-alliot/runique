...
2. [Prisme Extractor](#extracteur-prisme)
3. [Manual Approach: `RuniqueForm` Trait](#approche-manuelle-trait-runiqueform)
    1. [Basic Structure](#structure-de-base)
    2. [Methods of the `RuniqueForm` Trait](#methodes-du-trait-runiqueform)
    3. [Validation Pipeline `is_valid()`](#pipeline-de-validation-is_valid)
4. [Typed Conversion Helpers](#helpers-de-conversion-typee)
    1. [Direct Conversions](#conversions-directes)
    2. [Option Conversions](#conversions-option)
    3. [Usage in `save()`](#utilisation-dans-save)
5. [Field Types](#field-types)
    1. [TextField](#textfield---text-fields)
    2. [NumericField](#numericfield---numeric-fields)
    3. [BooleanField](#booleanfield---checkboxes--simple-radio)
    4. [ChoiceField](#choicefield---select--dropdown)
    5. [RadioField](#radiofield---radio-buttons)
    6. [CheckboxField](#checkboxfield---multiple-checkboxes)
    7. [DateField, TimeField, DateTimeField](#datefield-timefield-datetimefield---date--time)
    8. [DurationField](#durationfield---duration)
    9. [FileField](#filefield---file-uploads)
    10. [Associated JS Files](#associated-js-files)
    11. [ColorField](#colorfield---color-picker)
    12. [SlugField](#slugfield---url-friendly-slug)
    13. [UUIDField](#uuidfield)
    14. [JSONField](#jsonfield---textarea-with-json-validation)
    15. [IPAddressField](#ipaddressfield---ip-address)
...
11. [⚠️ Common Pitfalls](#⚠️-common-pitfalls)
