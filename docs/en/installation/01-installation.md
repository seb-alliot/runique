...
| Module | Description |
| --- | --- |
| [Prerequisites & Initial Setup](https://github.com/seb-alliot/runique/blob/main/docs/en/installation/prerequis/prerequis.md) | Rust, Git, clone the project, build, run |
| [Database](https://github.com/seb-alliot/runique/blob/main/docs/en/installation/base-de-donnees/base-de-donnees.md) | SQLite (dev), PostgreSQL (prod) |
