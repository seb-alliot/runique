...
| Module | Description |
| --- | --- |
| [Prerequisites & Initial Setup](https://github.com/seb-alliot/runique/blob/main/docs/en/installation/prerequisites/prerequisites.md)
| Rust, Git, clone the project, build, run |
| [Database](https://github.com/seb-alliot/runique/blob/main/docs/en/installation/database/database.md) 
