...
> **Intégration formulaires** : via `#[form(model = Entity)]`, un form expose `Form::objects` et supporte `search!(@Form => ...)`. Voir [Formulaires — attribut model](/docs/fr/model/formulaires).
