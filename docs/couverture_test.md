...
|------------|---------|--------|--------|-----------|
| Regions    | 9 530   | 14 178 | 67.22% | 61.86%    |
| Fonctions  | 1 048   | 1 367  | 76.66% | 72.42%    |
| Lignes     | 6 660   | 9 375  | 71.04% | 65.95%    |
...
| Fichier | Regions | Manquees | Cover | Fonctions | Manquees | Exec | Lignes | Manquees | Cover |
|---------|--------:|---------:|------:|----------:|---------:|-----:|-------:|---------:|------:|
| db\config.rs | 244 | 18 | **92.62%** | 25 | 0 | **100.00%** | 171 | 9 | **94.74%** |
...
| migration\makemigrations.rs | 394 | 108 | **72.59%** | 26 | 9 | **65.38%** | 199 | 48 | **75.88%** |
| migration\migrate.rs | 654 | 288 | **55.96%** | 38 | 9 | **76.32%** | 374 | 150 | **59.89%** |
...
| migration\utils\diff.rs | 149 | 0 | 100.00% | 20 | 0 | 100.00% | 117 | 0 | 100.00% |
| migration\utils\generators.rs | 440 | 113 | **74.55%** | 25 | 2 | **92.00%** | 387 | 101 | **73.90%** |
| migration\utils\helpers.rs | 652 | 204 | **68.71%** | 19 | 0 | **100.00%** | 343 | 107 | **68.81%** |
| migration\utils\parser_builder.rs | 310 | 32 | 89.68% | 11 | 0 | 100.00% | 165 | 7 | 95.76% |
...
## Fichiers a 0% (necessitent stack HTTP complet ou CLI)

| Fichier | Raison |
|---------|--------|
| app\runique_app.rs | Initialisation app complete |
| bin\runique.rs | Binaire CLI |
| context\request\extractor.rs | Extraction depuis requete HTTP |
| context\template.rs | Rendu template Axum |
| forms\extractor.rs | Extraction multipart/form HTTP |
| forms\model_form\mod.rs | Formulaire lie a modele ORM |
| macros\context\impl_error.rs | Macro impl_from_error! |
| utils\forms\parse_html.rs | Parsing HTML (necessite rendu) |
...
## Progressions notables cette session
...
| migration\utils\generators.rs | 65% | **74%** |
| migration\utils\helpers.rs | 67% | **69%** |

## Ce qui reste a couvrir (par priorite)

### Testable sans HTTP — effort moyen
| Fichier | Cover actuel | Cible |
|---------|-------------|-------|
| migration\utils\parser_seaorm.rs | 38% | 80% |
| migration\column\mod.rs | 59% | 85% |
| forms\fields\datetime.rs | 38% | 70% |
| forms\fields\file.rs | 42% | 70% |
| forms\fields\number.rs | 53% | 80% |
| middleware\dev\cache.rs | 41% | 75% |
| errors\error.rs | 35% | 70% |
| engine\core.rs | 32% | 70% |
| utils\password\mod.rs | 62% | 85% |

### Necessite stack HTTP complet — effort eleve
| Fichier | Cover actuel | Bloquant |
|---------|-------------|---------|
| context\template.rs | 0% | Axum + Tera full stack |
| context\request\extractor.rs | 0% | Requete HTTP Axum |
| forms\extractor.rs | 0% | Multipart/form HTTP |
| forms\model_form\mod.rs | 0% | ORM + HTTP |
| context\request_extensions.rs | 35% | Extensions requete |
