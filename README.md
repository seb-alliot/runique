...
[![Version](https://img.shields.io/badge/version-1.0.4-blue.svg)](https://crates.io/crates/runique)
...
# With PostgreSQL
[dependencies]
runique = { version = "1.0.4", features = ["postgres"] }

# With MySQL
[dependencies]
runique = { version = "1.0.4", features = ["mysql"] }

# With MariaDB
[dependencies]
runique = { version = "1.0.4", features = ["mariadb"] }

# With all databases
[dependencies]
runique = { version = "1.0.4", features = ["all-databases"] }
```
...
# PostgreSQL + MySQL
[dependencies]
runique = { version = "1.0.4", features = ["postgres", "mysql"] }
...
[dependencies]
runique = { version = "1.0.4", default-features = false }
```
