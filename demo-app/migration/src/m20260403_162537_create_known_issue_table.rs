...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("issue_type")).enum_type("IssueType", vec!["Manquant".to_string(), "Ajoute".to_string(), "Fix".to_string()]).not_null())
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Alias::new("known_issue"))
                .to_owned())
            .await?;
        Ok(())
    }
