        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new_with_type(Alias::new("theme"), ColumnType::Enum { name: Alias::new("SectionTheme").into_iden(), variants: vec![Alias::new("Demarrage").into_iden(), Alias::new("Web").into_iden(), Alias::new("Database").into_iden(), Alias::new("Security").into_iden(), Alias::new("Admin").into_iden(), Alias::new("Autres").into_iden()] }).null())
                    .to_owned()
            )
            .await?;
