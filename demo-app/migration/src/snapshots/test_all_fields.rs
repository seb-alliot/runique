        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("f_checkbox")).boolean().not_null())
                    .col(ColumnDef::new(Alias::new("f_radio_single")).boolean().not_null())
                    ...
                    .col(ColumnDef::new(Alias::new("f_date")).date().null())
                    .col(ColumnDef::new(Alias::new("f_time")).time().null())
