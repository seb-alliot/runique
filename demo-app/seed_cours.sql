...
macro_rules! mon_vec {
    ...
    ($e:expr; $n:expr)        => {{ let mut v = Vec::with_capacity($n); for _ in 0..$n { v.push($e); } v }};
}
...
(11095, 375, NULL, $BLK11095$Framework Rusti - Documentation Complète$BLK11095$, 'text', 2),
...
IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I   User (entité SeaORM)                    I<br>I   + impl_objects!(Entity)                 I<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I<br>M<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I   Objects<User>                           I<br>I   - Constante créée par la macro          I<br>I   - Méthodes: filter(), exclude(), etc.   I<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I<br>M<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I   RustiQueryBuilder<User>                 I<br>I   - Encapsule Select<User>                I<br>I   - Méthodes chainables                   I<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I<br>M<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>I   SeaORM Select<User>                     I<br>I   - Query SQL réelle                      I<br>IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII<br>**----- End of picture text -----**<br>$BLK11133$, 'text', 3),
...
(11153, 385, NULL, $BLK11153$Le `RustiQueryBuilder` encapsule la query SeaORM et permet de chaîner les méthodes.$BLK11153$, 'text', 1),
