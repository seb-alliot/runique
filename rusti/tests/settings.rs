...
fn test_settings_static_urls() {
    ...
    assert!(!settings.static_rusti_url.is_empty());
    assert!(!settings.media_rusti_url.is_empty());
}
...
fn test_settings_paths() {
    ...
    assert!(!settings.static_rusti_path.is_empty());
    assert!(!settings.media_rusti_path.is_empty());
}
