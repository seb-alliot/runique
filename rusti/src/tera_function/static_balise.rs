...
// NOUVEAUX FILTRES
pub fn register_static_filter(tera: &mut Tera, static_url: String) {
...
pub fn register_media_filter(tera: &mut Tera, media_url: String) {
...
pub fn register_rusti_static_filter(tera: &mut Tera, static_rusti_url: String) {
...
pub fn register_rusti_media_filter(tera: &mut Tera, media_rusti_url: String) {
