...
impl Default for StaticConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            static_runique_url: "/static/".to_string(),
            media_runique_path: media_runique_path,
            media_runique_url: "/media/".to_string(),
            templates_runique: templates_runique,
            templates_dir: vec!["templates".to_string()],
            staticfiles_dirs: "staticfiles".to_string(),
...
impl StaticConfig {
    pub fn from_env() -> Self {
        ...
        let staticfiles_dirs = std::env::var("STATICFILES_DIRS")
            .unwrap_or_else(|_| "staticfiles".to_string());
        let media_root = std::env::var("MEDIA_ROOT")
            .unwrap_or_else(|_| "media_root".to_string());
        let static_url = std::env::var("STATIC_URL")
            .unwrap_or_else(|_| "/static/".to_string());
        let media_url = std::env::var("MEDIA_URL")
            .unwrap_or_else(|_| "/media/".to_string());
        let staticfiles_storage = std::env::var("STATICFILES_STORAGE")
            .unwrap_or_else(|_| "default_storage".to_string());
        Self {
            base_dir,
            static_runique_path,
            static_runique_url,
