use crate::formulaire::builder_form::field_type::{
    number_mode::NumericField, text_mode::TextField,
};
...
impl FormField for GenericField {
    ...
    fn is_required(&self) -> bool {
        match &self.kind {
            FieldKind::Text(f) => f.is_required(),
            FieldKind::Numeric(f) => f.is_required(),
            _ => false,
        }
    }
