...
pub const ERROR_CORPS: &[(&str, &str)] = tpls![
    ...
    ("template-info.html", "errors/corps-error/template-info.html"),
    ("trace-error.html", "errors/corps-error/stack-trace-error.html"),
...
pub const ADMIN_TEMPLATES: &[(&str, &str)] = tpls![
    ...
    ("admin/list_partial.html", "admin/composant/list_partial.html"),
    ...
    ("admin/history_diff.html", "admin/composant/history_diff.html"),
    (
        "admin/history_timeline.html",
        "admin/composant/history_timeline.html"
    ),
    ("admin/history_batch.html", "admin/composant/history_batch.html"),
