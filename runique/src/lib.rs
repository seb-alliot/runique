...
// ---------------------------------------------------------------------------
// Moteurs de base de données mutuellement exclusifs
// ---------------------------------------------------------------------------
...
pub mod prelude {
    ...
    pub use crate::{
        context_update, error, flash_now, impl_form_access, impl_objects, info, search,
        search_cond, success, urlpatterns, view, warning,
    };
