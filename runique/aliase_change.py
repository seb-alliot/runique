...
REPLACEMENTS = [
    # HashMap<String, String> → StrMap
    {
        ...
        "replacement": "StrMap",
        "import": "use crate::aliases::StrMap;",
    ...
    # HashMap<String, Vec<String>> → StrVecMap
    {
        ...
        "import": "use crate::aliases::StrVecMap;",
    ...
    # HashMap<String, Value> → JsonMap
    {
        ...
        "replacement": "JsonMap",
        "import": "use crate::aliases::JsonMap;",
    ...
    # IndexMap<String, Box<dyn FormField>> → FieldsMap
    {
        ...
        "import": "use crate::aliases::FieldsMap;",
    ...
    # Vec<FlashMessage> → Messages
    {
        ...
        "import": "use crate::aliases::Messages;",
...
# Fichiers à ignorer
IGNORE_FILES = [
    "aliases/definition.rs",  # Fichier de définition des aliases
...
def has_existing_import(content: str, import_line: str) -> bool:
    ...
    clean_import = import_line.replace("use crate::aliases::", "").rstrip(";")
    
    # Cherche les patterns d'import possibles
    patterns = [
        rf"use crate::aliases::{re.escape(clean_import)};",
        rf"use crate::aliases::\{{[^}}]*{re.escape(clean_import)}[^}}]*\}};",
