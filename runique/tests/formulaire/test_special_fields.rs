...
#[tokio::test]
async fn test_color_field_valide_rrggbb() {
...
#[tokio::test]
async fn test_color_field_valide_rgb_court() {
    let mut field = ColorField::new("couleur");
    field.set_value("#F53");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_color_field_invalide_sans_diese() {
    let mut field = ColorField::new("couleur");
    field.set_value("FF5733");
    assert!(!field.validate().await);
...
#[tokio::test]
async fn test_color_field_invalide_longueur_incorrecte() {
    let mut field = ColorField::new("couleur");
...
#[tokio::test]
async fn test_color_field_invalide_caracteres_non_hex() {
    let mut field = ColorField::new("couleur");
...
#[tokio::test]
async fn test_color_field_requis_vide_echoue() {
...
#[tokio::test]
async fn test_color_field_optionnel_vide_passe() {
    let mut field = ColorField::new("couleur");
    field.set_value("");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_slug_field_ascii_valide() {
...
#[tokio::test]
async fn test_slug_field_avec_underscore() {
    let mut field = SlugField::new("slug");
...
#[tokio::test]
async fn test_slug_field_commence_par_tiret_echoue() {
    let mut field = SlugField::new("slug");
...
#[tokio::test]
async fn test_slug_field_finit_par_tiret_echoue() {
    let mut field = SlugField::new("slug");
    field.set_value("mon-article-");
    assert!(!field.validate().await);
    assert!(field.error().is_some());
...
#[tokio::test]
async fn test_slug_field_caracteres_speciaux_echoue() {
    let mut field = SlugField::new("slug");
    field.set_value("mon article");
    assert!(!field.validate().await);
    assert!(field.error().is_some());
...
#[tokio::test]
async fn test_slug_field_accents_sans_unicode_echoue() {
    let mut field = SlugField::new("slug");
...
#[tokio::test]
async fn test_slug_field_unicode_autorise() {
...
#[tokio::test]
async fn test_slug_field_requis_vide_echoue() {
    let mut field = SlugField::new("slug");
...
#[tokio::test]
async fn test_slug_field_optionnel_vide_passe() {
    let mut field = SlugField::new("slug");
    field.set_value("");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_uuid_field_valide() {
...
#[tokio::test]
async fn test_uuid_field_invalide_format() {
    let mut field = UUIDField::new("id");
...
#[tokio::test]
async fn test_uuid_field_invalide_incomplet() {
    let mut field = UUIDField::new("id");
...
#[tokio::test]
async fn test_uuid_field_requis_vide_echoue() {
...
#[tokio::test]
async fn test_uuid_field_optionnel_vide_passe() {
    let mut field = UUIDField::new("id");
    field.set_value("");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_json_field_objet_valide() {
...
#[tokio::test]
async fn test_json_field_tableau_valide() {
    let mut field = JSONField::new("donnees");
...
#[tokio::test]
async fn test_json_field_valeur_primitive_valide() {
    let mut field = JSONField::new("donnees");
    field.set_value("42");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_json_field_invalide() {
    let mut field = JSONField::new("donnees");
...
#[tokio::test]
async fn test_json_field_requis_vide_echoue() {
...
#[tokio::test]
async fn test_json_field_optionnel_vide_passe() {
    let mut field = JSONField::new("donnees");
    field.set_value("");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_ip_field_ipv4_valide() {
...
#[tokio::test]
async fn test_ip_field_ipv6_valide() {
    let mut field = IPAddressField::new("adresse");
...
#[tokio::test]
async fn test_ip_field_invalide() {
    let mut field = IPAddressField::new("adresse");
...
#[tokio::test]
async fn test_ip_field_pas_une_ip() {
    let mut field = IPAddressField::new("adresse");
...
#[tokio::test]
async fn test_ip_field_ipv4_only_rejette_ipv6() {
...
#[tokio::test]
async fn test_ip_field_ipv4_only_accepte_ipv4() {
    let mut field = IPAddressField::new("adresse").ipv4_only();
...
#[tokio::test]
async fn test_ip_field_ipv6_only_rejette_ipv4() {
...
#[tokio::test]
async fn test_ip_field_ipv6_only_accepte_ipv6() {
    let mut field = IPAddressField::new("adresse").ipv6_only();
    field.set_value("::1");
    assert!(field.validate().await);
    assert!(field.error().is_none());
...
#[tokio::test]
async fn test_ip_field_requis_vide_echoue() {
...
#[tokio::test]
async fn test_ip_field_optionnel_vide_passe() {
    let mut field = IPAddressField::new("adresse");
    field.set_value("");
    assert!(field.validate().await);
    assert!(field.error().is_none());
