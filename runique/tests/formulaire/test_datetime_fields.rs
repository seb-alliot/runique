...
#[tokio::test]
async fn test_date_field_vide_non_requis() {
...
#[tokio::test]
async fn test_date_field_vide_requis() {
...
#[tokio::test]
async fn test_date_field_requis_message_custom() {
    let mut field = DateField::new("date");
...
#[tokio::test]
async fn test_date_field_valide() {
    let mut field = DateField::new("date");
...
#[tokio::test]
async fn test_date_field_format_invalide() {
    let mut field = DateField::new("date");
...
#[tokio::test]
async fn test_date_field_format_invalide_texte() {
    let mut field = DateField::new("date");
...
#[tokio::test]
async fn test_date_field_min_respecte() {
...
#[tokio::test]
async fn test_date_field_min_viole() {
...
#[tokio::test]
async fn test_date_field_min_message_custom() {
    let min = NaiveDate::from_ymd_opt(2024, 6, 1).unwrap();
...
#[tokio::test]
async fn test_date_field_max_respecte() {
...
#[tokio::test]
async fn test_date_field_max_viole() {
...
#[tokio::test]
async fn test_date_field_max_message_custom() {
    let max = NaiveDate::from_ymd_opt(2024, 1, 1).unwrap();
...
#[tokio::test]
async fn test_time_field_vide_non_requis() {
...
#[tokio::test]
async fn test_time_field_vide_requis() {
...
#[tokio::test]
async fn test_time_field_requis_message_custom() {
    let mut field = TimeField::new("heure");
...
#[tokio::test]
async fn test_time_field_valide() {
    let mut field = TimeField::new("heure");
...
#[tokio::test]
async fn test_time_field_format_invalide() {
    let mut field = TimeField::new("heure");
...
#[tokio::test]
async fn test_time_field_format_invalide_texte() {
    let mut field = TimeField::new("heure");
...
#[tokio::test]
async fn test_time_field_min_respecte() {
...
#[tokio::test]
async fn test_time_field_min_viole() {
    let min = NaiveTime::from_hms_opt(8, 0, 0).unwrap();
    let mut field = TimeField::new("heure").min(min, "");
...
#[tokio::test]
async fn test_time_field_min_message_custom() {
    let min = NaiveTime::from_hms_opt(8, 0, 0).unwrap();
...
#[tokio::test]
async fn test_time_field_max_respecte() {
...
#[tokio::test]
async fn test_time_field_max_viole() {
    let max = NaiveTime::from_hms_opt(18, 0, 0).unwrap();
    let mut field = TimeField::new("heure").max(max, "");
...
#[tokio::test]
async fn test_time_field_max_message_custom() {
    let max = NaiveTime::from_hms_opt(18, 0, 0).unwrap();
...
#[tokio::test]
async fn test_datetime_field_vide_non_requis() {
...
#[tokio::test]
async fn test_datetime_field_vide_requis() {
...
#[tokio::test]
async fn test_datetime_field_requis_message_custom() {
    let mut field = DateTimeField::new("rdv");
...
#[tokio::test]
async fn test_datetime_field_valide() {
    let mut field = DateTimeField::new("rdv");
...
#[tokio::test]
async fn test_datetime_field_format_invalide() {
    let mut field = DateTimeField::new("rdv");
...
#[tokio::test]
async fn test_datetime_field_format_invalide_texte() {
    let mut field = DateTimeField::new("rdv");
...
#[tokio::test]
async fn test_datetime_field_min_respecte() {
...
#[tokio::test]
async fn test_datetime_field_min_viole() {
...
#[tokio::test]
async fn test_datetime_field_min_message_custom() {
    let min = NaiveDateTime::parse_from_str("2025-01-01T00:00", "%Y-%m-%dT%H:%M").unwrap();
...
#[tokio::test]
async fn test_datetime_field_max_respecte() {
...
#[tokio::test]
async fn test_datetime_field_max_viole() {
...
#[tokio::test]
async fn test_datetime_field_max_message_custom() {
    let max = NaiveDateTime::parse_from_str("2023-01-01T00:00", "%Y-%m-%dT%H:%M").unwrap();
...
#[tokio::test]
async fn test_duration_field_vide_non_requis() {
...
#[tokio::test]
async fn test_duration_field_vide_requis() {
...
#[tokio::test]
async fn test_duration_field_requis_message_custom() {
    let mut field = DurationField::new("duree");
...
#[tokio::test]
async fn test_duration_field_valide() {
    let mut field = DurationField::new("duree");
...
#[tokio::test]
async fn test_duration_field_invalide_texte() {
    let mut field = DurationField::new("duree");
...
#[tokio::test]
async fn test_duration_field_invalide_negatif() {
    let mut field = DurationField::new("duree");
    field.set_value("-60");
    assert!(!field.validate().await);
}
...
#[tokio::test]
async fn test_duration_field_min_respecte() {
...
#[tokio::test]
async fn test_duration_field_min_viole() {
...
#[tokio::test]
async fn test_duration_field_min_message_custom() {
...
#[tokio::test]
async fn test_duration_field_max_respecte() {
...
#[tokio::test]
async fn test_duration_field_max_viole() {
...
#[tokio::test]
async fn test_duration_field_max_message_custom() {
...
#[tokio::test]
async fn test_duration_field_zero_valide() {
    let mut field = DurationField::new("duree");
    field.set_value("0");
    assert!(field.validate().await);
}
